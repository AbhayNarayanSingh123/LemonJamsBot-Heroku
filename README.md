# LemonJamsBot - Heroku
## My fork of [this](https://github.com/AbhayNarayanSingh123/LemonJamsBot) repository 
...
### Webserver setup
* deploy [this](https://github.com/AbhayNarayanSingh123/LemonJamServer) repo in heroku (you can use ```deploy to heroku``` button for easy peasy deployment)
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/AbhayNarayanSingh123/LemonJamsBot-Heroku/tree/main)
